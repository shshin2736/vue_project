  ...
  <dl class="task-accordion">
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            ...
            @click="onMonSave('30', GV_STEP_DETAIL_LIST[8].stepCd, '0')"
          >
            <!-- 저장 -->
          ...
          <button
            ...
            :disabled="monDisabled"
            @click="onMonSave('30', GV_STEP_DETAIL_LIST[8].stepCd, '1')"
          >
            <!-- 완료 -->
          ...
          <button
            ...
            @click="openHelpPop(GV_STEP_DETAIL_LIST[8].stepNm, 'NLS0000778')"
          >
            <!-- 도움말 -->
            ...
            >
              ...
              <div class="task-inputform type4">
                ...
                <span class="task-datepicker">
                  <com-date-picker
                    :name="`monDate_${i}`"
                    :current="item.monDate ? item.monDate : new Date()"
                    :format="format"
                    :disabled="monDisabled"
                    @onChange="onChange"
                  ></com-date-picker>
    ...
    <validation-observer ref="obs9" v-slot="{ invalid, validated, errors }">
      ...
      >
        <button type="button" class="task-accordion-btn">
          <span
            >{{ GV_STEP_DETAIL_LIST[9].stepNm }}<em class="required-text">*</em>
          </span>
          <span
            class="task-state"
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[9].stepNm, 'NLS0000779')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[10].stepNm, 'NLS0000780')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check1"
                  value="SA01"
                  :check="reportCheck['SA01'] === true ? true : false"
                  labelId="check1"
              ...
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check2"
                  value="SA02"
                  :check="reportCheck['SA02'] === true ? true : false"
                  labelId="check2"
              ...
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check3"
                  value="SA03"
                  :check="reportCheck['SA03'] === true ? true : false"
                  labelId="check3"
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check10"
                  value="SA05"
                  :check="reportCheck['SA05'] === true ? true : false"
                  labelId="check10"
                  :labelTitle="$t('NLS0000613')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check20"
                  value="SA06"
                  :check="reportCheck['SA06'] === true ? true : false"
                  labelId="check20"
                  :labelTitle="$t('NLS0000614')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check30"
                  value="SA07"
                  :check="reportCheck['SA07'] === true ? true : false"
                  labelId="check30"
                  :labelTitle="$t('NLS0000612')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check40"
                  value="SA08"
                  :check="reportCheck['SA08'] === true ? true : false"
                  labelId="check40"
                  :labelTitle="$t('NLS0000615')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check11"
                  value="SA09"
                  :check="reportCheck['SA09'] === true ? true : false"
                  labelId="check11"
                  :labelTitle="$t('NLS0000618')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check21"
                  value="SA10"
                  :check="reportCheck['SA10'] === true ? true : false"
                  labelId="check21"
    ...
    <validation-observer ref="obs11" v-slot="{ invalid, validated, errors }">
      <dt
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[11].stepNm, 'NLS0000781')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
...
export default {
  name: 'ProjectExecutionDetailSAStep3Form',
  ...
  computed: {
    ...
    getMonList() {
      const item = this[specializedTasksTypes.getters.GET_PROJECT_MON_LIST];
      return item;
    },
    getEffectInfo() {
      const item = this[specializedTasksTypes.getters.GET_PROJECT_SA_EFFECT];
      return item;
    },
    getReportInfo() {
      const item = this[
  ...
  watch: {
    getPrjInfo: function(value) {
      if (!common.isEmpty(value.prjInfo)) {
        ...
        //* 현장적용 LIST 세팅
        this.setMonList(this.prjInfo.prjId);
        //* 효과파악 INFO 세팅
    ...
    getMonList: function(value) {
      if (!common.isEmpty(value)) {
        this.monList = value.reduce((acc, cur) => {
          const obj = { ...cur };
          obj.monDate = new Date(
            timezone.convertToClientTimeZone(obj.monDate, 'YYYY-MM-DD'),
          );
          obj.transContent = obj.transContent ? obj.transContent : '';
          obj.views = true;
          acc.push(obj);
          return acc;
        }, []);
    ...
    getEffectInfo: function(value) {
      this.effectInfo = value ? value : this.effectInfo;
    },
  ...
  methods: {
    ...
    //* 현장적용 저장
    async onMonSave(stepType, stepCd, stepStatus) {
      ...
      this.monList = this.monList.reduce((acc, cur) => {
        const obj = { ...cur };
        obj.monDate = timezone.convertToServerTimeZone(obj.monDate, 'YYYYMMDD');
        acc.push(obj);
        return acc;
      }, []);
      ...
      const params = {
        ...
        monList: this.monList,
        transContent: this.transContent,
        ...
        downloadType: stepCd,
        fileList: this.paramMonFileList,
      };
      await this[specializedTasksTypes.actions.UPDATE_PROJECT_MON_LIST](params);
      if (stepStatus === '1') {
    ...
    async onEffectSave(stepType, stepCd, stepStatus) {
      ...
      await this[specializedTasksTypes.actions.UPDATE_PROJECT_SA_EFFECT](
        params,
      );
      if (stepStatus === '1') {
    ...
    async onFinishSave(stepType, stepCd, stepStatus) {
      ...
      if (this.GV_invalid11) {
        common.alert('warning', this.GV_errors11.msg);
        return false;
      }
      const params = {
        prjId: this.prjInfo.prjId,
    ...
    async onBestProject() {
      // 우수과제로 선정하시겠습니까?
      common.confirm(this.$('NLS0000913'), async () => {
    ...
    getMonFiles(files) {
      this.paramMonFileList = files;
    },
    getEffectFiles(files) {
      this.paramEffectFileList = files;
    },
    async setMonList(prjId) {
      await this[specializedTasksTypes.actions.FETCH_PROJECT_MON_LIST]({
        prjId: prjId,
      });
    },
    async setEffectInfo(prjId) {
      await this[specializedTasksTypes.actions.FETCH_PROJECT_SA_EFFECT]({
        prjId: prjId,
      });
    ...
    onChange(date, name) {
      ...
      if (name.includes('monDate')) this.monList[idx].monDate = date;
    },
    //* 과제도움말 팝업
