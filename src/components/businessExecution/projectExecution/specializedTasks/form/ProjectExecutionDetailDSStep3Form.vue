      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            ...
            @click="onRiskSave('30', GV_STEP_DETAIL_LIST[8].stepCd, '0')"
          >
            <!-- 저장 -->
          ...
          <button
            ...
            :disabled="riskDisabled"
            @click="onRiskSave('30', GV_STEP_DETAIL_LIST[8].stepCd, '1')"
          >
            <!-- 완료 -->
          ...
          <button
            ...
            @click="openHelpPop(GV_STEP_DETAIL_LIST[8].stepNm, 'NLS0000770')"
          >
            <!-- 도움말 -->
          ...
          <div class="sub-accordion-wrap">
            ...
            >
              ...
              <div class="accordion-line">
                <!-- 추진계획 -->
                <span class="sub-title">{{ $t('NLS0000900') }}</span>
                <p class="text">{{ item.implPlan }}</p>
              </div>
              <div class="task-textform type1">
                <!-- 상세 추진계획 -->
                <label for="detailPlan" class="required-field">
                  {{ $t('NLS0000601') }}
                  <span class="required-text">*</span>
                </label>
                <com-ck-editor
                  ...
                  :disable="riskDisabled"
                ></com-ck-editor>
              </div>
              <div class="task-textform type1">
                <label for="expRisk" class="required-field">
                  <!-- 예상 Risk -->
                  {{ $t('NLS0000602') }}
                  <span class="required-text">*</span>
                </label>
                <com-ck-editor
                  ...
                  rules="requiredCK|required"
                  :id="`expRisk${i}`"
                  v-model="item.expRisk"
                  :disable="riskDisabled"
                ></com-ck-editor>
              </div>
              <div class="task-textform type1">
                <label for="expMeasure" class="required-field">
                  <!-- 대응 방안 -->
                  {{ $t('NLS0000603') }}
                  <span class="required-text">*</span>
                </label>
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[9].stepNm, 'NLS0000771')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
        ...
        <div class="hmstask-form-box">
          ...
          <div class="task-textform">
            <!-- 정성적 효과 -->
            <label for="qltEff">- {{ $t('NLS0000553') }}</label>
            <com-ck-editor
              v-if="editorRender"
              id="qltEff"
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[10].stepNm, 'NLS0000772')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check1"
                  value="DS01"
                  :check="reportCheck['DS01'] === true ? true : false"
                  labelId="check1"
              ...
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check2"
                  value="DS02"
                  :check="reportCheck['DS02'] === true ? true : false"
                  labelId="check2"
              ...
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check3"
                  value="DS03"
                  :check="reportCheck['DS03'] === true ? true : false"
                  labelId="check3"
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check10"
                  value="DS05"
                  :check="reportCheck['DS05'] === true ? true : false"
                  labelId="check10"
                  :labelTitle="$t('NLS0001451')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check20"
                  value="DS06"
                  :check="reportCheck['DS06'] === true ? true : false"
                  labelId="check20"
                  :labelTitle="$t('NLS0000899')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check30"
                  value="DS07"
                  :check="reportCheck['DS07'] === true ? true : false"
                  labelId="check30"
                  :labelTitle="$t('NLS0000923')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check40"
                  value="DS08"
                  :check="reportCheck['DS08'] === true ? true : false"
                  labelId="check40"
                  :labelTitle="$t('NLS0001458')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
            ...
            <div class="task-check-wrap__row">
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check11"
                  value="DS09"
                  :check="reportCheck['DS09'] === true ? true : false"
                  labelId="check11"
                  :labelTitle="$t('NLS0000924')"
                  :disable="reportDisabled"
                  @change="reportChecked"
                />
              </div>
              <div class="task-check-form">
                ...
                <com-input-text
                  ...
                  id="check21"
                  value="DS10"
                  :check="reportCheck['DS10'] === true ? true : false"
                  labelId="check21"
      ...
      <dd>
        <div class="accordion-inner-btnbox">
          ...
          <button
            type="button"
            class="accordion-btn info"
            @click="openHelpPop(GV_STEP_DETAIL_LIST[11].stepNm, 'NLS0000773')"
          >
            <!-- 도움말 -->
            <span>{{ $t('NLS0000823') }}</span>
          </button>
...
export default {
  name: 'ProjectExecutionDetailDSStep3Form',
  ...
  computed: {
    ...
    getEffectInfo() {
      const item = this[specializedTasksTypes.getters.GET_PROJECT_DS_EFFECT];
      return item;
    },
    getReportInfo() {
      const item = this[
  ...
  watch: {
    getPrjInfo: function(value) {
      if (!common.isEmpty(value.prjInfo)) {
        ...
        //* 첨부파일 (현장적용)
        this.getFileList(value.prjInfo.prjId);

        //* 현장적용 LIST 세팅 implList
    ...
    getRiskList: function(value) {
      if (!common.isEmpty(value)) {
        this.riskList = value.reduce((acc, cur) => {
          const obj = { ...cur };
          if (obj.detailPlan === null) obj.detailPlan = '';
          if (obj.expRisk === null) obj.expRisk = '';
          if (obj.expMeasure === null) obj.expMeasure = '';
          obj.views = true;
          acc.push(obj);
          return acc;
        }, []);
  ...
  methods: {
    ...
    //* 현장적용 저장
    async onRiskSave(stepType, stepCd, stepStatus) {
      ...
      const params = {
        ...
        downloadType: stepCd,
        fileList: this.paramRiskFileList,
      };
      await this[specializedTasksTypes.actions.UPDATE_PROJECT_RISK_LIST](
        params,
      );
      if (stepStatus === '1') {
    ...
    async onEffectSave(stepType, stepCd, stepStatus) {
      ...
      await this[specializedTasksTypes.actions.UPDATE_PROJECT_DS_EFFECT](
        params,
      );
      if (stepStatus === '1') {
    ...
    getRiskFiles(files) {
      this.paramRiskFileList = files;
    },
    getEffectFiles(files) {
      this.paramEffectFileList = files;
    },
    async setRiskList(prjId) {
      await this[specializedTasksTypes.actions.FETCH_PROJECT_IMPL_LIST]({
        prjId: prjId,
      });
    },
    async setEffectInfo(prjId) {
      await this[specializedTasksTypes.actions.FETCH_PROJECT_DS_EFFECT]({
        prjId: prjId,
      });
    },
    reportChecked(e) {
        ...
        if (i == idx) {
          ...
          if (idx === 8) {
            if (
              ...
              // this[specializedTasksTypes.actions.FETCH_PROJECT_DATE_INFO]({
              //   prjId: this.prjInfo.prjId,
              //   title: this.GV_STEP_LIST[2].cdNm,
              //   prjStep: '30',
              // });
              // this[specializedTasksTypes.actions.INIT_VIEWS_MEASURE_DATE_POP](
              //   true,
              // );
            }
          }
    ...
    openRiskeAll(openFlag) {
      this.openAll = !openFlag;
      this.riskList = this.riskList.reduce((acc, cur) => {
        const obj = { ...cur };
      ...
      for (let item of this.allFileList) {
        switch (item.downloadType) {
          case this.GV_STEP_DETAIL_LIST[8].stepCd:
            this.riskFileList.push(item); // Risk관리
            break;
