...
export const getters = {
  ...
  GET_TEAM_BOARD_LIST: 'GET_TEAM_BOARD_LIST', //* 저장된 팀 게시판 리스트 가져오기
  GET_TEAM_BOARD_DETAIL: 'GET_TEAM_BOARD_DETAIL', //* 저장된 팀 게시판 내용 가져오기
...
export const actions = {
  ...
  FETCH_TEAM_BOARD_LIST: 'FETCH_TEAM_BOARD_LIST', //* 팀 게시판 리스트 가져오기
  FETCH_TEAM_BOARD_DETAIL: 'FETCH_TEAM_BOARD_DETAIL', //* 선택한 팀 게시판 내용 가져오기
...
export const mutations = {
  ...
  SET_TEAM_BOARD_LIST: 'SET_TEAM_BOARD_LIST', //* 팀 게시판 리스트 저장하기
  SET_TEAM_BOARD_DETAIL: 'SET_TEAM_BOARD_DETAIL', //* 선택한 팀 게시판 내용 저장하기
