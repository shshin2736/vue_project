...
!(function(e, t) {
  ...
  var s = (function(e) {
    ...
    o = (function(e) {
      function n(n, r) {
        ...
        (o.computeDateVars = t.memoize(i)),
          (o.eventStoreToSegs = t.memoize(o._eventStoreToSegs)),
          (o.renderSkeleton = t.memoizeRendering(
            o._renderSkeleton,
            o._unrenderSkeleton,
          ));
        var a = (o.eventRenderer = new s(o));
        return (
          (o.renderContent = t.memoizeRendering(
            a.renderSegs.bind(a),
            a.unrender.bind(a),
            [o.renderSkeleton],
          )),
      ...
      return (
        ...
        (n.prototype.firstContext = function(e) {
          e.calendar.registerInteractiveComponent(this, { el: this.el });
        }),
        (n.prototype.render = function(t, n) {
          ...
          (this.dayDates = s),
            ...
            this.renderContent(
              n,
              this.eventStoreToSegs(t.eventStore, t.eventUiBases, o),
            );
        }),
        ...
        (n.prototype._renderSkeleton = function(e) {
          ...
          for (
            var r = 0, s = (n.getClass('listView') || '').split(' ');
            r < s.length;
            r++
          ) {
            var o = s[r];
          ...
          for (r = 0; r < n.length; r++)
            if (
              ...
              !o.isEnd &&
                !c &&
                r + 1 < n.length &&
                d.end < a.add(n[r + 1].start, l))
            ) {
              (o.end = d.end), (o.isEnd = !0);
              break;
            }
          return p;
        }),
          ...
          var n,
            ...
            a = t.htmlToElement(
              '<table class="fc-list-table ' +
                o.getClass('tableList') +
                '"><tbody></tbody></table>',
            ),
            l = a.querySelector('tbody');
          for (n = 0; n < i.length; n++)
            if ((r = i[n]))
              for (
                l.appendChild(this.buildDayHeaderRow(this.dayDates[n])),
                  r = this.eventRenderer.sortEventSegs(r),
                  s = 0;
                s < r.length;
                s++
              )
                l.appendChild(r[s].el);
        ...
        (n.prototype.buildDayHeaderRow = function(e) {
          var n = this.context,
            ...
            s = n.dateEnv,
            o = n.options,
            i = t.createFormatter(o.listDayFormat),
            a = t.createFormatter(o.listDayAltFormat);
          return t.createElement(
            'tr',
            {
              className: 'fc-list-heading',
              'data-date': s.formatIso(e, { omitTime: !0 }),
            },
            '<td class="' +
              (r.getClass('tableListHeading') || r.getClass('widgetHeader')) +
              '" colspan="3">' +
              (i
  ...
  function i(e) {
    for (
      var n = t.startOfDay(e.renderRange.start),
        r = e.renderRange.end,
        s = [],
        o = [];
      n < r;
      ...
      s.push(n),
        o.push({ start: n, end: t.addDays(n, 1) }),
        (n = t.addDays(n, 1));
    return { dayDates: s, dayRanges: o };
  }
