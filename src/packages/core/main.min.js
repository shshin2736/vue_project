...
!(function(e, t) {
        ...
        !(function(e, t, n, r) {
          ...
          for (var p in s) {
            ...
            for (
              ...
              var R = w[T],
                C = Se({}, n, { range: h.range, allDay: y.allDay }),
                I = D.defs[y.defId],
                M = D.instances[p],
                k = void 0;
              if (
                ((k = I ? new ct(t, I, M) : new ct(t, y)),
                !R(t.buildDateSpanApi(C), k))
              )
                return !1;
            }
          }
  ...
  function Zt(e, t, n, r) {
    ...
    if (a)
      return (
        ((s = jt(o, t, a.allDay, Boolean(a.duration), n)).recurringDef = {
          typeId: a.typeId,
          typeData: a.typeData,
          duration: a.duration,
        }),
  ...
  function $t(e, t, n, r, i) {
    ...
    return (
      ...
      (u = { date: t.formatIso(o, { omitTime: !0 }), type: a || 'day' }),
      ...
      (i = i || ''),
      !s && e.navLinks
        ? '<a' + r + ' data-goto="' + Pt(JSON.stringify(u)) + '">' + i + '</a>'
        : '<span' + r + '>' + i + '</span>'
    );
  }
  function en(e, t, n, r) {
    ...
    hn = (function() {
      function e(e, t, n, r, i) {
        (this.calendar = e),
          ...
          (this.nextDayThreshold = J(r.nextDayThreshold));
      }
      return (
    ...
    vn = (function() {
      ...
      return (
        ...
        (e.prototype.receiveProps = function(e, t) {
          var n = this.context;
          (this.context = t), n || this.firstContext(t);
  ...
  (gn.prototype.fgSegSelector = '.fc-event-container > *'),
    (gn.prototype.bgSegSelector = '.fc-bgevent:not(.fc-nonbusiness)');
  var yn = 0;
  function mn(e) {
    return {
      id: String(yn++),
  ...
  function In(e, t, n) {
    for (
      var r = Ie(t.state.eventSources), i = [], o = 0, a = e;
      o < a.length;
      o++
    ) {
      ...
      return (
        ...
        (e.prototype.compute = function() {
          ...
          (this.dirDefaults = i),
            ...
            (this.computed = Te(
              [Mn, i, r, this.overrides, this.dynamicOverrides],
              _n,
            ));
        }),
        e
  ...
  var gr = (function(e) {
      function t(t) {
        var n = e.call(this) || this;
        return (
          (n._renderLayout = Xt(n.renderLayout, n.unrenderLayout)),
          ...
          (n.el = r('div', { className: 'fc-toolbar ' + t })),
          n
        );
      }
      return (
                      ...
                      : ((r = f[e])
                          ...
                          : u[e] &&
                            ...
                            (g = p[e]) ||
                              ...
                              (g = h[e])),
                        d &&
                          ((m = ['fc-' + e + '-button', a.getClass('button')]),
                          g
                            ? ((y = Pt(g)), (S = ''))
                            : v &&
                              ((y = "<span class='" + v + "'></span>"),
    ...
    yr = (function(e) {
      function t(t) {
        ...
        return (
          ...
          (n.renderToolbars = Xt(n._renderToolbars, n._unrenderToolbars, [
            n.renderSkeleton,
          ])),
          (n.buildComponentContext = Ye(Er)),
          (n.buildViewPropTransformers = Ye(Sr)),
          (n.el = t),
          (n.computeTitle = Ye(mr)),
      ...
      return (
        ...
        (t.prototype._renderSkeleton = function(e) {
          this.updateElClassNames(e),
            u(
              this.el,
              (this.contentEl = r('div', { className: 'fc-view-container' })),
            );
          for (
            var t = e.calendar,
              n = 0,
              i = t.pluginSystem.hooks.viewContainerModifiers;
            n < i.length;
            n++
          ) {
        ...
        (t.prototype._renderToolbars = function(e, t, n, r) {
          ...
          d
            ? (o ||
                ((o = this.header = new gr('fc-header-toolbar')),
                u(this.el, o.el)),
              o.receiveProps(Se({ layout: d }, m), i))
            : o && (o.destroy(), (o = this.header = null)),
            f
              ? (a ||
                  ((a = this.footer = new gr('fc-footer-toolbar')),
                  s(this.el, a.el)),
                a.receiveProps(Se({ layout: f }, m), i))
        ...
        (t.prototype.queryToolbarsHeight = function() {
          var e = 0;
          return (
            this.header && (e += C(this.header.el)),
            this.footer && (e += C(this.footer.el)),
            e
          );
        }),
    ...
    wr = (function(e) {
      function t(t) {
        ...
        return (
          ...
          u.context.calendar.on('eventElRemove', n.handleEventElRemove),
          n
        );
      }
      return (
  ...
  (Rr.prototype.classes = {
    ...
    (Rr.prototype.baseIconClass = 'fc-icon'),
    (Rr.prototype.iconClasses = {
      close: 'fc-icon-x',
    ...
    (Rr.prototype.iconOverrideOption = 'buttonIcons'),
    (Rr.prototype.iconOverrideCustomButtonOption = 'icon'),
    (Rr.prototype.iconOverridePrefix = 'fc-icon-');
  var Cr = (function() {
    function e(e, t) {
      var n = this;
      (this.buildComponentContext = Ye(Ir)),
        (this.parseRawLocales = Ye(xn)),
        (this.buildLocale = Ye(Nn)),
        (this.buildDateEnv = Ye(Mr)),
        (this.buildTheme = Ye(kr)),
        (this.buildEventUiSingleBase = Ye(this._buildEventUiSingleBase)),
        (this.buildSelectionConfig = Ye(this._buildSelectionConfig)),
        (this.buildEventUiBySource = qe(Or, Me)),
        (this.buildEventUiBases = Ye(Pr)),
    ...
    return (
      ...
      (e.prototype.renderComponent = function() {
        ...
        var i = (this.renderableEventStore =
            e.eventSourceLoadingLevel && !this.opt('progressiveEventRendering')
      ...
      (e.prototype.handleOptions = function(e) {
        ...
        (this.dateEnv = this.buildDateEnv(
          ...
          (this.viewSpecs = vr(n.views, this.optionsManager)),
      ...
      (e.prototype.addEvent = function(e, t) {
        ...
        var a = Zt(e, i, this);
        return a
          ? (this.dispatch({ type: 'ADD_EVENTS', eventStore: _e(a) }),
  ...
  var xr = (function(e) {
    function t(t, n) {
      var i =
        e.call(
          this,
          r('div', { className: 'fc-view fc-' + t.type + '-view' }),
        ) || this;
      return (
        (i.renderDatesMem = Xt(i.renderDatesWrap, i.unrenderDatesWrap)),
        (i.renderBusinessHoursMem = Xt(
          i.renderBusinessHours,
          i.unrenderBusinessHours,
          [i.renderDatesMem],
        )),
        (i.renderDateSelectionMem = Xt(
          i.renderDateSelectionWrap,
          i.unrenderDateSelectionWrap,
          [i.renderDatesMem],
        )),
        (i.renderEventsMem = Xt(i.renderEvents, i.unrenderEvents, [
          i.renderDatesMem,
        ])),
        (i.renderEventSelectionMem = Xt(
          i.renderEventSelectionWrap,
          i.unrenderEventSelectionWrap,
          [i.renderEventsMem],
        )),
        (i.renderEventDragMem = Xt(
          i.renderEventDragWrap,
          i.unrenderEventDragWrap,
          [i.renderDatesMem],
        )),
        (i.renderEventResizeMem = Xt(
    ...
    return (
      ...
      (t.prototype.renderDatesWrap = function(e) {
        this.renderDates(e),
          this.addScroll({ duration: J(this.context.options.scrollTime) });
      }),
      ...
      (t.prototype.startNowIndicator = function(e, t) {
        ...
        a.options.nowIndicator &&
          ...
          (i =
            u.add(u.startOf(this.initialNowDate, n), J(1, n)).valueOf() -
  ...
  rn.mixInto(xr),
    (xr.prototype.usesMinMaxTime = !1),
    (xr.prototype.dateProfileGeneratorClass = $n);
  var Nr = (function() {
    function e() {
        ...
        (e.prototype.renderSegEls = function(e, t) {
          ...
          if (t.length) {
            ...
            o(i).forEach(function(e, n) {
              ...
              'bgEvent' === e && (t = ft(this.context, t, !1)),
              (t = t.filter(function(e) {
  ...
  function Br(e) {
    ...
    return (
      (e = Se({ timeZone: Mn.timeZone, calendarSystem: 'gregory' }, e, {
        locale: t,
      })),
      new Fn(e)
    );
  ...
  function Wr(e, t, n, r, i, o, a, s) {
    ...
    return (
      (u =
        'function' == typeof d.columnHeaderHtml
          ? d.columnHeaderHtml(l.toDate(e))
          : 'function' == typeof d.columnHeaderText
          ? Pt(d.columnHeaderText(l.toDate(e)))
          : Pt(l.format(e, i))),
      n ? (p = p.concat(en(e, t, o, !0))) : p.push('fc-' + P[e.getUTCDay()]),
      '<th class="' +
        p.join(' ') +
        '"' +
        (f && n
        ...
        (s ? ' ' + s : '') +
        '>' +
        (f ? $t(d, l, { date: e, forceOff: !n || 1 === r }, u) : u) +
        '</th>'
    );
  }
  var Zr = (function(e) {
      ...
      return (
        ...
        (t.prototype.render = function(e, t) {
          ...
          for (
            var o = ot(t.options.columnHeaderFormat || Fr(r, n.length)),
              a = 0,
              s = n;
            a < s.length;
            a++
    ...
    qr = (function() {
      ...
      return (
        (e.prototype.sliceProps = function(e, t, n, r, i) {
          for (var o = [], a = 5; a < arguments.length; a++)
            o[a - 5] = arguments[a];
          var s = e.eventUiBases,
            u = this.sliceEventStore.apply(
              this,
              [e.eventStore, s, t, n, i].concat(o),
            );
          return {
            dateSelectionSegs: this.sliceDateSelection.apply(
              this,
              [e.dateSelection, s, i].concat(o),
            ),
            ...
            eventDrag: this.sliceEventDrag.apply(
              this,
              [e.eventDrag, s, t, n, i].concat(o),
            ),
            eventResize: this.sliceEventResize.apply(
              this,
              [e.eventResize, s, t, n, i].concat(o),
            ),
            eventSelection: e.eventSelection,
          };
        }),
        (e.prototype.sliceNowDate = function(e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            [{ range: { start: e, end: N(e, 1) }, allDay: !1 }, {}, t].concat(
              n,
            ),
          );
        }),
        (e.prototype._sliceBusinessHours = function(e, t, n, r, i) {
          ...
          return e
            ? this._sliceEventStore.apply(
                this,
                [Oe(e, Gr(t, Boolean(n)), r), {}, t, n, i].concat(o),
              ).bg
            : [];
        }),
        ...
        (e.prototype._sliceDateSpan = function(e, t, n) {
          ...
          if (!e) return [];
          for (
            var o = lr(e, t, n.context.calendar),
  ...
  function Gr(e, t) {
    ...
    return t
      ? n
      : {
          start: N(n.start, e.minTime.milliseconds),
          end: N(n.end, e.maxTime.milliseconds - 864e5),
        };
  }
  (e.Calendar = Cr),
    (e.Component = vn),
    (e.ComponentContext = hn),
    (e.DateComponent = gn),
    (e.DateEnv = Fn),
    ...
    (e.DaySeries = jr),
    (e.DayTable = Yr),
    (e.ElementDragging = Lr),
    (e.ElementScrollController = ln),
    (e.EmitterMixin = rn),
    (e.EventApi = ct),
    (e.FgEventRenderer = Nr),
    (e.FillRenderer = Ur),
    (e.Interaction = br),
    (e.Mixin = nn),
    (e.NamedTimeZoneImpl = zr),
    (e.PositionCache = sn),
    (e.ScrollComponent = dn),
    (e.ScrollController = un),
    (e.Slicer = qr),
    (e.Splitter = Kt),
    (e.Theme = fn),
    (e.View = xr),
    (e.WindowScrollController = cn),
    (e.addDays = x),
    ...
    (e.eventTupleToStore = _e),
    (e.filterEventStoreDefs = Ue),
    (e.filterHash = we),
