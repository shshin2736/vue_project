...
(function(global, factory) {
  ...
  function isInteractionPropsValid(
    ...
    for (var subjectInstanceId in subjectInstances) {
      ...
      for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
        ...
        if (
          !subjectAllow(calendar.buildDateSpanApi(subjectDateSpan), eventApi)
        ) {
          return false;
        }
      }
  ...
  var Toolbar = /** @class */ (function(_super) {
    ...
    Toolbar.prototype.toggleButtonEnabled = function(buttonName, bool) {
      findElements(this.el, '.fc-' + buttonName + '-button').forEach(function(
        buttonEl,
      ) {
  ...
  var CalendarComponent = /** @class */ (function(_super) {
    ...
    function CalendarComponent(el) {
      ...
      _this.renderToolbars = memoizeRendering(
        _this._renderToolbars,
        _this._unrenderToolbars,
    ...
    CalendarComponent.prototype._renderToolbars = function(
      viewSpec,
      dateProfile,
      currentDate,
      title,
    ...
    CalendarComponent.prototype.renderView = function(props, title) {
      ...
      var transformers = this.buildViewPropTransformers(
        calendar.pluginSystem.hooks.viewPropsTransformers,
      );
      for (
        var _i = 0, transformers_1 = transformers;
        _i < transformers_1.length;
      ...
      view.receiveProps(
        viewProps,
        this.buildComponentContext(this.context, viewSpec, view),
      );
    };
    // Sizing
    // -----------------------------------------------------------------------------------------------------------------
    ...
    CalendarComponent.prototype.computeHeightVars = function() {
      ...
      if (typeof contentHeightInput === 'number') {
        ...
        this.viewHeight =
          parentEl.getBoundingClientRect().height - this.queryToolbarsHeight();
      } else {
  ...
  var Calendar = /** @class */ (function() {
    ...
    Calendar.prototype.hydrate = function() {
      ...
      this.batchRendering(function() {
        ...
        _this.dispatch({
          type: 'SET_VIEW_TYPE',
          viewType:
            _this.opt('defaultView') || _this.pluginSystem.hooks.defaultView,
        });
      });
    };
    ...
    Calendar.prototype.addEventSource = function(sourceInput) {
      if (sourceInput instanceof EventSourceApi) {
        // not already present? don't want to add an old snapshot
        if (
          !this.state.eventSources[sourceInput.internalEventSource.sourceId]
        ) {
          this.dispatch({
  ...
  var View = /** @class */ (function(_super) {
    ...
    View.prototype.getNowIndicatorUnit = function(
      dateProfile,
      dateProfileGenerator,
    ) {
    ...
    FillRenderer.prototype.renderSegs = function(type, context, segs) {
      ...
      if (containerEls) {
        (_a =
          ...
          (this.containerElsByType[type] = [])).push.apply(_a, containerEls);
      }
