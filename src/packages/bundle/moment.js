...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('moment'), require('fullcalendar'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'moment', 'fullcalendar'], factory)
    : ((global = global || self),
      factory(
...
})(this, function(exports, momentNs, fullcalendar) {
  'use strict';
  ...
  function formatWithCmdStr(cmdStr, arg) {
    ...
    if (arg.end) {
      var startMom = convertToMoment(
        arg.start.array,
        arg.timeZone,
        arg.start.timeZoneOffset,
        arg.localeCodes[0],
      );
      var endMom = convertToMoment(
        arg.end.array,
        arg.timeZone,
