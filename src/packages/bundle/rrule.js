...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('rrule'), require('fullcalendar'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'rrule', 'fullcalendar'], factory)
    : ((global = global || self),
      factory(
...
})(this, function(exports, rrule, fullcalendar) {
  'use strict';
  ...
  var recurring = {
    parse: function(rawEvent, leftoverProps, dateEnv) {
      if (rawEvent.rrule != null) {
        var props = fullcalendar.refineProps(
          rawEvent,
          EVENT_DEF_PROPS,
          {},
          leftoverProps,
