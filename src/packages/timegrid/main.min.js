        ...
        (r.prototype.renderSegHtml = function(e, r) {
          ...
          if ((p.unshift('fc-time-grid-event'), t.isMultiDayRange(s.range))) {
            if (e.isStart || e.isEnd) {
              ...
              (i = this._getTimeText(g, m, d)),
                (n = this._getTimeText(g, m, d, this.fullTimeFormat)),
          ...
          return (
            ...
            (i
              ...
              : '') +
            (a.title
              ? '<div class="fc-title">' + t.htmlEscape(a.title) + '</div>'
              : '') +
            '</div>' +
          ...
          for (
            ...
            (r = s.add(c, h)),
              ...
              (n =
                ...
                (i
                  ? '<span>' +
                    t.htmlEscape(s.format(r, this.labelFormat)) +
                    '</span>'
                  : '') +
                '</td>'),
              (d +=
        ...
        (i.prototype._renderColumns = function(e, i) {
          ...
          for (var h = 0; h < this.colCnt; h++)
            o.publiclyTrigger('dayRender', [
              { date: d.toDate(e[h].date), el: this.colEls[h], view: s },
            ]);
              ...
              ? ((e = o.format(a.start, g)),
                '<th class="fc-axis fc-week-number ' +
                  ...
                  t.buildGotoAnchorHtml(
                    s,
                    o,
                    { date: a.start, type: 'week', forceOff: l > 1 },
                    t.htmlEscape(e),
                  ) +
                  '</th>')
              : '<th class="fc-axis ' +
    ...
    return (
      ...
      (r.prototype.render = function(e, t) {
        ...
        this.timeGrid.receiveProps(
          o(
            {},
            this.slicer.sliceProps(e, i, null, t.calendar, this.timeGrid, s),
      ...
      return (
        ...
        (i.prototype._renderSkeleton = function(i) {
          e.prototype._renderSkeleton.call(this, i),
            ...
            this.dayGrid &&
              (this.simpleDayGrid = new r.SimpleDayGrid(this.dayGrid));
        }),
        (i.prototype._unrenderSkeleton = function() {
