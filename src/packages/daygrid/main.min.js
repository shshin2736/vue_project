...
!(function(e, t) {
      ...
      return (
        ...
        (r.prototype.renderSegHtml = function(e, r) {
          ...
          return (
            ...
            e.isStart &&
              (n = this.getTimeText(s)) &&
              (m = '<span class="fc-time">' + t.htmlEscape(n) + '</span>'),
            (i =
              '<span class="fc-title">' +
            ...
            '<a class="' +
              ...
              '</div>' +
              (h ? '<div class="fc-resizer fc-start-resizer"></div>' : '') +
      ...
      return (
        ...
        (r.prototype.renderSegRow = function(e, r) {
          ...
          for (n = 0; n < f; n++) {
            ...
            C && (c ? t.appendToElement(s, C) : t.prependToElement(s, C)),
              m.appendChild(s);
          }
          return {
            row: e,
        ...
        (r.prototype.buildSegLevels = function(e) {
          ...
          for (e = this.sortEventSegs(e), t = 0; t < e.length; t++) {
            ...
            (r.level = n),
              (r.leftCol = i ? o - 1 - r.lastCol : r.firstCol),
              (r.rightCol = i ? o - 1 - r.firstCol : r.lastCol),
              (s[n] || (s[n] = [])).push(r);
          }
  ...
  var h = (function(e) {
        ...
        (r.prototype.attachSegs = function(e, r) {
          ...
          this.dayGrid.rowEls.forEach(function(e, r) {
            ...
            n && n.row === r
              ...
              (s =
                o.getBoundingClientRect().top - e.getBoundingClientRect().top),
              (l.style.top = s + 'px'),
    ...
    p = (function(e) {
      ...
      return (
        n(r, e),
        (r.prototype.renderSegs = function(t, r, n) {
          'bgEvent' === t &&
        ...
        (r.prototype.renderFillRow = function(e, r) {
          ...
          (n = 'businessHours' === e ? 'bgevent' : e.toLowerCase()),
            ...
            d > 0 &&
              t.appendToElement(
                o,
                new Array(d + 1).join('<td style="pointer-events:none"></td>'),
              ),
            (r.el.colSpan = c - d),
            o.appendChild(r.el),
            c < a &&
              t.appendToElement(
                o,
                new Array(a - c + 1).join(
                  '<td style="pointer-events:none"></td>',
                ),
              );
          var h = s.renderProps.renderIntroHtml();
          return (
            h && (l ? t.appendToElement(o, h) : t.prependToElement(o, h)), i
          );
        }),
        r
      );
  ...
  function g(e, r, n, i) {
    ...
    return (
      ...
      '<td class="' +
        a.join(' ') +
        '"' +
        (l ? ' data-date="' + o.formatIso(e, { omitTime: !0 }) + '"' : '') +
        (i ? ' ' + i : '') +
        '></td>'
    );
  }
  var y = t.createFormatter({ day: 'numeric' }),
    ...
    b = (function(e) {
      function r(r, n) {
        ...
        var l = (i.renderCells = t.memoizeRendering(
          i._renderCells,
          i._unrenderCells,
        ));
        return (
          (i.renderBusinessHours = t.memoizeRendering(
            s.renderSegs.bind(s, 'businessHours'),
            s.unrender.bind(s, 'businessHours'),
            [l],
          )),
          (i.renderDateSelection = t.memoizeRendering(
            s.renderSegs.bind(s, 'highlight'),
            s.unrender.bind(s, 'highlight'),
            [l],
          )),
          (i.renderBgEvents = t.memoizeRendering(
      ...
      return (
        ...
        (r.prototype.renderNumberCellHtml = function(e) {
          ...
          return d || this.renderProps.cellWeekNumbersVisible
            ? ((r = t.getDayClasses(
                e,
          ...
          for (t = 0; t < n.length; t++)
            this.unlimitRow(t),
              !1 !==
                (r =
                  !!e &&
                  ('number' == typeof e ? e : this.computeRowLevelLimit(t))) &&
                this.limitRow(t, r);
        }),
        ...
        (r.prototype.limitRow = function(e, r) {
          ...
          if (r && r < w.segLevels.length) {
            for (
              n = w.segLevels[r - 1],
                i = w.cellMatrix,
                (o = t.findChildren(w.tbodyEl).slice(r)).forEach(function(e) {
              ...
              if (d) {
                for (
                  ...
                  (m = t.createElement('td', {
                    ...
                    (a = c[f]),
                    (y = this.renderMoreLink(e, H + f, [l].concat(a))),
                    (g = t.createElement('div', null, y)),
                    m.appendChild(g),
                    u.push(m),
                    C.push(m);
        ...
        (r.prototype.renderMoreLink = function(e, r, n) {
          ...
          return (
            (h.innerText = this.getMoreLinkText(n.length)),
            h.addEventListener('click', function(t) {
              ...
              'function' == typeof o &&
                (o = s.publiclyTrigger('eventLimitClick', [
                  {
                    date: a.toDate(p),
                    allDay: !0,
                    dayEl: f,
                ...
                'popover' === o
                  ? i.showSegPopover(e, r, u, g)
                  : 'string' == typeof o && s.zoomTo(p, o);
            }),
            h
          );
        }),
        (r.prototype.showSegPopover = function(e, r, n, i) {
          var o,
            ...
            g = n.parentNode;
          (o = 1 === this.rowCnt ? h.el : this.rowEls[e]),
            (l = {
              ...
              autoHide: !0,
              content: function(t) {
                (a.segPopoverTile = new u(t)),
                  a.updateSegPopoverTile(a.props.cells[e][m].date, i);
              },
              hide: function() {
            ...
            f
              ? (l.right = t.computeRect(g).right + 1)
              : (l.left = t.computeRect(g).left - 1),
    ...
    w = (function(e) {
      function r() {
        ...
        return (
          (r.processOptions = t.memoize(r._processOptions)),
          ...
          (r.renderHeadIntroHtml = function() {
            var e = r.context,
              n = e.theme,
              i = e.options;
            return r.colWeekNumbersVisible
              ? '<th class="fc-week-number ' +
                  n.getClass('widgetHeader') +
                  '" ' +
                  r.weekNumberStyleAttr() +
                  '><span>' +
                  t.htmlEscape(i.weekLabel) +
                  '</span></th>'
              : '';
          }),
            ...
            return r.colWeekNumbersVisible
              ? '<td class="fc-week-number" ' +
                  ...
                  t.buildGotoAnchorHtml(
                    o,
                    s,
                    { date: l, type: 'week', forceOff: 1 === n.colCnt },
                    s.format(l, S),
                  ) +
                  '</td>'
              : '';
      ...
      return (
        ...
        (r.prototype._renderSkeleton = function(e) {
          ...
          this.el.querySelector('.fc-body > tr > td').appendChild(r),
            r.classList.add('fc-day-grid-container');
          var n = t.createElement('div', { className: 'fc-day-grid' });
          r.appendChild(n),
            (this.dayGrid = new b(n, {
        ...
        (r.prototype.updateBaseSize = function(e, r, n) {
          ...
          s.rowEls
            ...
            : n ||
              ((i = this.computeScrollerHeight(r)), this.scroller.setHeight(i));
        }),
        ...
        (t.prototype.render = function(e, t) {
          ...
          r.receiveProps(
            i(
              ...
              { dateProfile: n, cells: o.cells, isRigid: e.isRigid },
            ),
            t,
          );
        }),
      ...
      return (
        ...
        (r.prototype._renderSkeleton = function(r) {
          e.prototype._renderSkeleton.call(this, r),
            r.options.columnHeader &&
              (this.header = new t.DayHeader(
                this.el.querySelector('.fc-head-container'),
              )),
            (this.simpleDayGrid = new C(this.dayGrid));
        }),
        (r.prototype._unrenderSkeleton = function() {
