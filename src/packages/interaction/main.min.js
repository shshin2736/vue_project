...
!(function(e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : t(((e = e || self).FullCalendarInteraction = {}), e.FullCalendar);
})(this, function(e, t) {
  'use strict';
  var n = function(e, t) {
    return (n =
        ...
        (this.subjectEl = null),
          ...
          (this.handleTouchStart = function(e) {
            if (n.tryStart(e)) {
              ...
              var r = e.target;
              n.shouldIgnoreMove ||
                r.addEventListener('touchmove', n.handleTouchMove),
          ...
          a++ || window.addEventListener('touchmove', c, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function() {
          this.containerEl.removeEventListener(
            ...
            --a || window.removeEventListener('touchmove', c, { passive: !1 });
        }),
        (e.prototype.tryStart = function(e) {
          ...
          return (
            !(
              !n ||
              (this.handleSelector && !t.elementClosest(r, this.handleSelector))
            ) &&
            ((this.subjectEl = n),
            (this.downEl = r),
            (this.isDragging = !0),
        ...
        (e.prototype.createEventFromTouch = function(e, t) {
          ...
          return (
            ...
            t
              ...
              : ((o = n - this.origPageX), (a = r - this.origPageY)),
            {
              origEvent: e,
              isTouch: !0,
              subjectEl: this.subjectEl,
      ...
      return (
        ...
        (e.prototype.doRevertAnimation = function(e, n) {
          ...
          (r.style.transition = 'top ' + n + 'ms,left ' + n + 'ms'),
            t.applyStyle(r, { left: i.left, top: i.top }),
        ...
        (e.prototype.cleanup = function() {
          this.mirrorEl &&
            (t.removeElement(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null);
        }),
        (e.prototype.updateElPosition = function() {
          this.sourceEl &&
            this.isVisible &&
            t.applyStyle(this.getMirrorEl(), {
        ...
        (e.prototype.getMirrorEl = function() {
          ...
          return (
            n ||
              ((n = this.mirrorEl = this.sourceEl.cloneNode(!0)).classList.add(
                'fc-unselectable',
              ),
    ...
    v = (function() {
      ...
      return (
        ...
        (e.prototype.handleMove = function(e, t) {
          if (this.isEnabled) {
            ...
            i < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(p()));
          }
        }),
        ...
        (e.prototype.computeBestEdge = function(e, t) {
          for (
            var n = this.edgeThreshold, r = null, i = 0, o = this.scrollCaches;
            i < o.length;
            i++
          ) {
            var a = o[i],
            ...
            s >= 0 &&
              ...
              g <= n &&
                ...
                a.canScrollDown() &&
                (!r || r.distance > g) &&
                (r = { scrollCache: a, name: 'bottom', distance: g }),
              s <= n &&
                this.everMovedLeft &&
                a.canScrollLeft() &&
                (!r || r.distance > s) &&
                (r = { scrollCache: a, name: 'left', distance: s }),
              c <= n &&
                this.everMovedRight &&
                a.canScrollRight() &&
                (!r || r.distance > c) &&
    ...
    E = (function() {
      ...
      return (
        ...
        (e.prototype.isWithinClipping = function(e, n) {
          for (
            var r, i, o = { left: e, top: n }, a = 0, l = this.scrollCaches;
            a < l.length;
            a++
          ) {
            var s = l[a];
            if (
              ...
              'HTML' !== (i = r.tagName) &&
                'BODY' !== i &&
                !t.pointInsideRect(o, s.clientRect))
            )
              return !1;
          }
          return !0;
  ...
  var m = (function() {
    ...
    return (
      (e.prototype.processFirstCoord = function(e) {
        var n,
          r = { left: e.pageX, top: e.pageY },
          i = r,
          o = e.subjectEl;
        o !== document &&
          ((n = t.computeRect(o)), (i = t.constrainPoint(i, n)));
        ...
        for (var a in r) {
          ...
          if (s.isWithinClipping(e, n)) {
            ...
            if (g >= 0 && g < p && u >= 0 && u < v) {
              ...
              !f ||
                (l.props.dateProfile &&
                  !t.rangeContainsRange(
                    l.props.dateProfile.activeRange,
                    f.dateSpan.range,
                  )) ||
                (o && !(f.layer > o.layer)) ||
                ((f.rect.left += c),
  ...
  function S(e, n) {
    return (
      (!e && !n) ||
      (Boolean(e) === Boolean(n) && t.isDateSpansEqual(e.dateSpan, n.dateSpan))
    );
  }
  var y = (function(e) {
      function n(n) {
          ...
          (r.handleDragEnd = function(e) {
            ...
            if (!r.dragging.pointer.wasTouchScroll) {
              ...
              a &&
                l &&
                S(a, l) &&
                n.triggerDateClick(a.dateSpan, a.dayEl, i, e.origEvent);
            }
          });
        var i = n.component;
        (r.dragging = new f(i.el)), (r.dragging.autoScroller.isEnabled = !1);
        var o = (r.hitDragging = new m(
          r.dragging,
          t.interactionSettingsToStore(n),
        ));
        return (
    ...
    D = (function(e) {
      function n(n) {
          ...
          (r.handleHitUpdate = function(e, n) {
            ...
            e &&
              (((a = (function(e, n, r) {
                ...
                e,
                o.pluginSystem.hooks.dateSelectionTransformers,
              )) &&
                r.component.isDateSelectionValid(a)) ||
                ((l = !0), (a = null))),
              a
                ? o.dispatch({ type: 'SELECT_DATES', selection: a })
                : n || o.dispatch({ type: 'UNSELECT_DATES' }),
              l ? t.disableCursor() : t.enableCursor(),
              n || (r.dragSelection = a);
          }),
        ...
        (l.touchScrollAllowed = !1),
          (l.minDistance = a.selectMinDistance || 0),
          (l.autoScroller.isEnabled = a.dragScroll);
        var s = (r.hitDragging = new m(
          r.dragging,
          t.interactionSettingsToStore(n),
        ));
        return (
    ...
    function n(r) {
      ...
      (o.subjectSeg = null),
        ...
        (o.handlePointerDown = function(e) {
          ...
          (o.relevantEvents = t.getRelevantEvents(c.state.eventStore, g)),
            (a.minDistance = e.isTouch ? 0 : s.eventDragMinDistance),
            (a.delay =
              e.isTouch && g !== i.props.eventSelection
                ? (function(e) {
                    var t = e.context.options,
                ...
                : null),
            (l.parentNode = c.el),
            (l.revertDuration = s.dragRevertDuration);
          var u = i.isValidSegDownEl(n) && !t.elementClosest(n, '.fc-resizer');
          a.setIgnoreMove(!u),
            (o.isDragging =
              u && e.subjectEl.classList.contains('fc-draggable'));
        }),
        (o.handleDragStart = function(e) {
          ...
          e.isTouch
            ? a !== o.component.props.eventSelection &&
              r.dispatch({ type: 'SELECT_EVENT', eventInstanceId: a })
              ...
              a === l || (h.editable && h.droppable)
                ? (s = (function(e, n, r) {
                    ...
                    i.allDay !== o.allDay &&
                      ((s.allDay = o.allDay),
                      (s.hasEnd =
                        n.component.context.options.allDayMaintainDuration),
                      o.allDay && (a = t.startOfDay(a)));
                    var c = t.diffDates(
                      a,
                      l,
                    ...
                    for (
                      var d = { datesDelta: c, standardProps: s }, g = 0, u = r;
                      g < u.length;
                      g++
                    ) {
                      var h = u[g];
                    ...
                    return d;
                  })(i, e, l.pluginSystem.hooks.eventDragMutationMassagers)) &&
                  ((c = t.applyMutationToEventStore(r, l.eventUiBases, s, l)),
                  (g.mutatedEvents = c),
                  u.isInteractionValid(g) ||
                    ((d = !0),
                    (s = null),
                    (c = null),
                    (g.mutatedEvents = t.createEmptyEventStore())))
                : (l = null);
            }
            o.displayDrag(l, g),
              d ? t.disableCursor() : t.enableCursor(),
              n ||
                (a === l && S(i, e) && (s = null),
            ...
            if (
              ...
              if (s === r) {
                ...
                for (
                  var f = {},
                    E = 0,
                    m = r.pluginSystem.hooks.eventDropTransformers;
                  E < m.length;
                  E++
                ) {
                  var S = m[E];
                ...
                var y = i({}, f, {
                  ...
                  delta: c.datesDelta,
                  oldEvent: u,
                  event: new t.EventApi(
                    r,
                    p.defs[d.defId],
                    g ? p.instances[g.instanceId] : null,
                  ),
                  revert: function() {
                    r.dispatch({ type: 'MERGE_EVENTS', eventStore: h });
                  },
                  jsEvent: e.origEvent,
                  view: a,
                });
                ...
                r.publiclyTrigger('eventLeave', [
                  { draggedEl: e.subjectEl, event: u, view: a },
                ]),
                  r.dispatch({
                ...
                s.publiclyTrigger('drop', [D]),
                  s.publiclyTrigger('eventReceive', [
                    {
                      draggedEl: e.subjectEl,
                      event: new t.EventApi(
                        s,
                        p.defs[d.defId],
                        p.instances[g.instanceId],
                      ),
                      view: v.component,
                    },
                  ]);
      ...
      (s.pointer.selector = n.SELECTOR),
        (s.touchScrollAllowed = !1),
        (s.autoScroller.isEnabled = l.dragScroll);
      var c = (o.hitDragging = new m(o.dragging, t.interactionSettingsStore));
      return (
        (c.useSubjectCenter = r.useEventCenter),
  ...
  var T = (function(e) {
    function n(n) {
      ...
      (r.draggingSeg = null),
        ...
        (r.handleDragStart = function(e) {
          var n = r.component.context,
            ...
            o = n.view,
            a = r.eventRange;
          (r.relevantEvents = t.getRelevantEvents(
            i.state.eventStore,
        ...
        (r.handleHitUpdate = function(e, n, o) {
          ...
          e &&
            (d = (function(e, n, r, o, a) {
              for (
                var l = e.component.context.dateEnv,
                  s = e.dateSpan.range.start,
                  c = n.dateSpan.range.start,
                  d = t.diffDates(s, c, l, e.component.largeUnit),
                  g = {},
                  u = 0,
                  h = a;
                u < h.length;
              ...
              c.range,
              a.pluginSystem.hooks.eventResizeJoinTransforms,
            )),
            d &&
              ((g = t.applyMutationToEventStore(l, a.eventUiBases, d, a)),
              (h.mutatedEvents = g),
              r.component.isInteractionValid(h) ||
                ((u = !0), (d = null), (g = null), (h.mutatedEvents = null))),
            g
              ? a.dispatch({ type: 'SET_EVENT_RESIZE', state: h })
              : a.dispatch({ type: 'UNSET_EVENT_RESIZE' }),
            u ? t.disableCursor() : t.enableCursor(),
            n ||
              (d && S(s, e) && (d = null),
              (r.validMutation = d),
              (r.mutatedRelevantEvents = g));
        }),
        (r.handleDragEnd = function(e) {
          var n = r.component.context,
            i = n.calendar,
          ...
          i.publiclyTrigger('eventResizeStop', [
            { el: r.draggingSeg.el, event: s, jsEvent: e.origEvent, view: o },
          ]),
            r.validMutation
                ...
                i.publiclyTrigger('eventResize', [
                  {
                    el: r.draggingSeg.el,
                    startDelta:
                      r.validMutation.startDelta || t.createDuration(0),
                    ...
                    revert: function() {
                      i.dispatch({ type: 'MERGE_EVENTS', eventStore: c });
                    },
                    jsEvent: e.origEvent,
                    view: o,
                  },
      ...
      (a.pointer.selector = '.fc-resizer'),
        (a.touchScrollAllowed = !1),
        (a.autoScroller.isEnabled = o.context.options.dragScroll);
      var l = (r.hitDragging = new m(
        r.dragging,
        t.interactionSettingsToStore(n),
      ));
      return (
        l.emitter.on('pointerdown', r.handlePointerDown),
        l.emitter.on('dragstart', r.handleDragStart),
        l.emitter.on('hitupdate', r.handleHitUpdate),
        l.emitter.on('dragend', r.handleDragEnd),
        r
      );
    }
    return (
      ...
      (n.prototype.querySeg = function(e) {
        return t.getElSeg(
          t.elementClosest(e.subjectEl, this.component.fgSegSelector),
        );
      }),
      n
    );
        ...
        (this.isRecentPointerDateSelect = !1),
          ...
          (this.onDocumentPointerUp = function(e) {
            ...
            if (!o.wasTouchScroll) {
              ...
              a.eventSelection &&
                !t.elementClosest(o.downEl, w.SELECTOR) &&
                i.dispatch({ type: 'UNSELECT_EVENT' });
            }
      ...
      function e(e, n) {
        ...
        (this.receivingCalendar = null),
          ...
          (this.handleHitUpdate = function(e, n, o) {
            ...
            e &&
              ((l = e.component.context.calendar),
              r.canDropElOnCalendar(o.subjectEl, l) &&
                ((s = (function(e, n, r) {
                  for (
                    var o = i({}, n.leftoverProps),
                      a = 0,
                      l = r.pluginSystem.hooks.externalDefTransforms;
                    a < l.length;
                    a++
                  ) {
                    var s = l[a];
                  ...
                  var c = t.parseEventDef(
                      o,
                      n.sourceId,
                      e.allDay,
                      r.opt('forceEventDuration') || Boolean(n.duration),
                      r,
                    ),
                    d = e.range.start;
                  e.allDay &&
                    n.startTime &&
                    (d = r.dateEnv.add(d, n.startTime));
                  var g = n.duration
                      ? r.dateEnv.add(d, n.duration)
                      : r.getDefaultEventEnd(e.allDay, d),
                    u = t.createEventInstance(c.defId, { start: d, end: g });
                  return { def: c, instance: u };
                })(e.dateSpan, r.dragMeta, l)),
                (d.mutatedEvents = t.eventTupleToStore(s)),
                (c = !t.isInteractionValid(d, l)) &&
                  ((d.mutatedEvents = t.createEmptyEventStore()), (s = null)))),
              r.displayDrag(l, d),
              a.setMirrorIsVisible(
                n || !s || !document.querySelector('.fc-mirror'),
              ),
              c ? t.disableCursor() : t.enableCursor(),
              n ||
                (a.setMirrorNeedsRevert(!s),
                (r.receivingCalendar = l),
                (r.droppableEvent = s));
          }),
          (this.handleDragEnd = function(e) {
            var n = r,
      ...
      return (
        ...
        (e.prototype.canDropElOnCalendar = function(e, n) {
          ...
          return 'function' == typeof r
            ? r(e)
            : 'string' != typeof r || !r || Boolean(t.elementMatches(e, r));
        }),
        e
      );
    })();
          ...
          (this.handlePointerDown = function(e) {
            ...
            (n.minDistance =
              null != o
                ...
                : e.isTouch
                ? 0
                : t.globalDefaults.eventDragMinDistance),
              (n.delay = e.isTouch
                ? null != a
                  ? a
                  : t.globalDefaults.longPressDelay
                : 0);
          }),
          (this.handleDragStart = function(e) {
            e.isTouch &&
  ...
  (e.Draggable = C),
    (e.FeaturefulElementDragging = f),
    (e.PointerDragging = s),
    (e.ThirdPartyDraggable = I),
    (e.default = P),
